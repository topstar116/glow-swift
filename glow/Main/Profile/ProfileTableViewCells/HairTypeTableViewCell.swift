...
class HairTypeTableViewCell: UITableViewCell {

    @IBOutlet weak var collectionView: UICollectionView!
    let type = ["Fine", "Oily", "Treated", "Dry", "Thick"]
    var hexColorString = ""
     var selectedHairType = ""
...
extension HairTypeTableViewCell:  UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if cell.selectedLabel.text?.lowercased() == selectedHairType.lowercased() {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        self.selectedHairType = self.type[indexPath.item]
        ...
        NotificationCenter.default.post(name: NSNotification.Name(rawValue: "HairType"), object: self.selectedHairType)
    }
