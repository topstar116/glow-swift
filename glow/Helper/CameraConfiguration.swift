        ...
        func configureDeviceInputs() throws {
            ...
            if let rearCamera = self.rearCamera {
                ...
                if captureSession.canAddInput(self.rearCameraInput!) {
                    ...
                    captureSession.canSetSessionPreset(AVCaptureSession.Preset.iFrame1280x720)
...
//            }
    ...
    func removeObserver() {
//        self.removeObserver(self, forKeyPath: UIDevice.orientationDidChangeNotification.rawValue)
    ...
    func recordVideo(completion: @escaping (URL?, Error?)-> Void) {
        ...
        let uniq = Date().timeIntervalSince1970
        let fileUrl = paths[0].appendingPathComponent("\(uniq)_recordVideo.mp4")
